...
const Registrofuncionari = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const { nombres, apellidos, numeroDocumento, email, tipoElemento, cantidad, color,} = nuevoRegistro;
    if (!nombres || !apellidos || !numeroDocumento || !email || !tipoElemento || !cantidad || !color) {
